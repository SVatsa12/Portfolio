...
export const PinContainer = ({
  ...
  return (
    <a
      className={cn("relative z-50 cursor-pointer group/pin", containerClassName)}
    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl border border-white/[0.1] bg-black-100 p-4 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.2]"
        >
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none z-[60] flex h-80 w-96 items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="-mt-7 h-full w-full flex-none">
